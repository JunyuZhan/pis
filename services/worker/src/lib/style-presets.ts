...
export const STYLE_PRESETS: Record<string, StylePreset> = {
  ...
  "cinematic-portrait": {
    ...
    cssFilter:
      "brightness(0.95) contrast(1.25) saturate(0.85) hue-rotate(15deg)",
  },
  "realistic-portrait": {
  ...
  vintage: {
    ...
    cssFilter:
      "brightness(1.05) contrast(1.15) saturate(1.1) hue-rotate(15deg)",
  },
  cool: {
    id: "cool",
    name: "冷色调",
  ...
  "moody-street": {
    ...
    cssFilter:
      "brightness(0.85) contrast(1.2) saturate(0.8) hue-rotate(-12deg)",
  },
  "emerald-forest": {
    id: "emerald-forest",
    name: "森林绿意",
    ...
    cssFilter:
      "brightness(0.95) contrast(1.1) saturate(1.25) hue-rotate(-5deg)",
  },
  "retro-vhs": {
    id: "retro-vhs",
    name: "复古胶片 (VHS)",
